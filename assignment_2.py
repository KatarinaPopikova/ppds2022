...
def use_two_barriers(barrier_1, barrier_2, thread_name):
    ...
    :param barrier_1: Instance of TurnstileBarrier or EventBarrier
    :param barrier_2: Instance of TurnstileBarrier or EventBarrier
    :param thread_name: Name of thread with id
...
def second_variation(thread_count):
    ...
    eb_1 = EventBarrier(thread_count)
    eb_2 = EventBarrier(thread_count)
